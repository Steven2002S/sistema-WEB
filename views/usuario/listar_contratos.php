...
<head>
    ...
    <title>Contratos - Finanzas</title>
                ...
                <tbody>
                    <?php if (!empty($contratos)): ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($contrato['mes_pagado']); ?></td>
                            <td><?php echo ucfirst(str_replace('_', ' ', htmlspecialchars($contrato['forma_pago']))); ?></td>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="8" style="text-align: center;">No hay contratos registrados</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
